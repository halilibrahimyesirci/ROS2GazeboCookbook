...
The maintainer develops on Windows and cannot run ROS 2 / Gazebo locally, so CI
is the source of truth: it builds each recipe, launches it headless, and asserts
the expected topics. If you *can* run the sim locally, please do — and say what
you saw in your PR. CI is the backstop, not a substitute for a working demo.
