"""Load a world that pulls models from Gazebo Fuel by URI.

One command (needs internet on first run to download the models):
...
def launch_setup(context, *args, **kwargs):
    pkg = get_package_share_directory('rgc_spawn_from_fuel')
    world = os.path.join(pkg, 'worlds', 'fuel_world.sdf')
